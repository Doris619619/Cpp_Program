/****************************************************************************
** Meta object code from reading C++ file 'admin_window.hpp'
**
...
#include "../../../../include/seatui/admin/admin_window.hpp"
...
#error "The header file 'admin_window.hpp' doesn't include <QObject>."
...
void AdminWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onHelpArrived((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        default: ;
        }
    }
}
