/****************************************************************************
** Meta object code from reading C++ file 'student_window.hpp'
**
...
#include "../../../../include/seatui/student/student_window.hpp"
...
#error "The header file 'student_window.hpp' doesn't include <QObject>."
...
void StudentWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->gotoDashboard(); break;
        case 5: _t->gotoNavigation(); break;
        case 6: _t->gotoHeatmap(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &StudentWindow::backToLoginRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StudentWindow::backToLoginRequested()
{
